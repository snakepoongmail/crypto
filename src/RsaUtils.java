...
public class RsaUtils {
    ...
    private static final String PRIVATE_KEY = "MIIEvQIBADANBgkqhkiG9w0BAQEFAASCBKcwggSjA" +
    ...
    public static void main(String[] args){
        try {
            ...
            //=========================使用公钥加密
            String encrypt = RsaUtils.encrypt("hello world", null, "utf-8");
            //=========================使用私钥解密
            String decrypt = RsaUtils.decrypt(encrypt, null, "utf-8");
